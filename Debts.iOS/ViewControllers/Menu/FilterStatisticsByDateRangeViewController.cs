...
{
    public class FilterStatisticsByDateRangeViewController : BaseViewController<FilterStatisticsByDateViewModel, string>
    {
        private InkTouchController _inkTouchController;

        public FilterStatisticsByDateRangeViewController()
        {
                
        }

        public FilterStatisticsByDateRangeViewController(IntPtr ptr) : base(ptr)
        {
        ...
        protected override IEnumerable<IMvxMessageObserver> GetMessageObservers()
        {
            ...
            observers.Add(new InvokeActionMessageObserver<PickDateMvxMessage>(msg =>
            {
                ...
                if (msg.Tag == FilterStatisticsByDateViewModel.StartDatePickerTag)
                {
                    title = "Select start date";
                } else if (msg.Tag == FilterStatisticsByDateViewModel.EndDatePickerTag)
        ...
        public override void ViewDidLoad()
        {
            ...
            startDateView.AddConstraints(
                ...
                startDateContent.AtBottomOfSafeArea(startDateView)
            );
            ...
            var set = this.CreateBindingSet<FilterStatisticsByDateRangeViewController, FilterStatisticsByDateViewModel>();
        ...
        public static UIViewController Show(FilterStatisticsByDateViewModel viewModel)
        {
            var mainViewController = UIApplication.SharedApplication.KeyWindow.RootViewController as MainViewController;
            var contentViewController = new FilterStatisticsByDateRangeViewController()
            {
                ViewModel = viewModel
            };
