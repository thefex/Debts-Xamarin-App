...
{
    public class FilterFinancesByDateRangeViewController : BaseViewController<FilterFinancesByDateViewModel, string>
    {
        private InkTouchController _inkTouchController;
        public FilterFinancesByDateRangeViewController()
        {
                
        }

        public FilterFinancesByDateRangeViewController(IntPtr ptr) : base(ptr)
        {
        ...
        protected override IEnumerable<IMvxMessageObserver> GetMessageObservers()
        {
            ...
            observers.Add(new InvokeActionMessageObserver<PickDateMvxMessage>(msg =>
            {
                ...
                if (msg.Tag == FilterFinancesByDateViewModel.StartDatePickerTag)
                {
                    title = "Select start date";
                } else if (msg.Tag == FilterFinancesByDateViewModel.EndDatePickerTag)
        ...
        public override void ViewDidLoad()
        {
            ...
            var set = this.CreateBindingSet<FilterFinancesByDateRangeViewController, FilterFinancesByDateViewModel>();
        ...
        public static UIViewController Show(FilterFinancesByDateViewModel viewModel)
        {
            var mainViewController = UIApplication.SharedApplication.KeyWindow.RootViewController as MainViewController;
            var contentViewController = new FilterFinancesByDateRangeViewController()
            {
                ViewModel = viewModel
            };
