...
{
    public abstract class BasePickBudgetCategoryViewController<TViewModel> : BaseListViewController<TViewModel, string, BudgetCategory, BudgetCategory>
        where TViewModel : PickBudgetCategoryViewModel
    {
        private BannerView _adBannerView;
        private UISearchBar searchBar;

        public BasePickBudgetCategoryViewController()
        {
        }

        public BasePickBudgetCategoryViewController(IntPtr handle) : base(handle)
        {
        }

        public BasePickBudgetCategoryViewController(string nibName, NSBundle bundle) : base(nibName, bundle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            TableView.ContentInset = new UIEdgeInsets(0, 0, 12, 0);

            var set = this.CreateBindingSet<BasePickBudgetCategoryViewController<TViewModel>, PickBudgetCategoryViewModel>();
        ...
        protected UIView GetHeaderView()
        {
        ...
        public override string EmptyListText => string.Empty;
        ...
        protected override MvxTemplateSelector GetTemplateSelector() => new DefaultMvxTemplateSelector(TableView, typeof(BudgetCategoryCell));
        protected string PageTitle => TextResources.PickBudgetCategory_Title;
    }
}