...
{
    public class EnterFinanceOperationNamePageViewController : MvxViewController
    {
        ...
        public EnterFinanceOperationNamePageViewController()
        {
        }

        public EnterFinanceOperationNamePageViewController(NSCoder coder) : base(coder)
        {
        }
 
        protected EnterFinanceOperationNamePageViewController(NSObjectFlag t) : base(t)
        {
        }

        protected internal EnterFinanceOperationNamePageViewController(IntPtr handle) : base(handle)
        {
        }

        public EnterFinanceOperationNamePageViewController(string nibName, NSBundle bundle) : base(nibName, bundle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            UILabel titleLabel = new UILabel()
            {
                ...
                Text = TextResources.AddFinanceOperation_Page_1_Title,
            ...
            UILabel contentLabel = new UILabel()
            {
                ...
                Text = TextResources.AddFinanceOperation_Page_1_Content,
                TextAlignment = UITextAlignment.Center,
                Lines = 0
            };
            ...
            var set = this
                .CreateBindingSet<EnterFinanceOperationNamePageViewController, AddFinanceOperationViewModel>();
        ...
        private void PreparePicker(UIView anchor)
        {
            ...
            {
                var financeOperationCell = (DropDownTypeCell) cell;

                financeOperationCell.Type = value;
            };

            _operationPicker.SelectionAction += (index, value) =>
            {
                var item = (ViewModel as AddFinanceOperationViewModel).AvailableTypes.FirstOrDefault(x => x.ToString() == value);
                (ViewModel as AddFinanceOperationViewModel).Type = item;
