...
{
    public class FinanceOperationDetailsGroupingDataConverter : MvxExpandableDataConverter
    {
        ...
        public override MvxGroupedData ConvertToMvxGroupedData(object item)
        {
            ...
            var groupedData = new MvxGroupedData()
            {
                ...
                GroupItems = (financeDetailsSection as DetailsNotesSection)?.Notes ?? Enumerable.Empty<object>(),
                UniqueId = key
            };
