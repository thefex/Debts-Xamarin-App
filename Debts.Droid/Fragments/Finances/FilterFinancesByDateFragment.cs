...
namespace Debts.Droid.Fragments.Finances
{
    ...
    public class FilterFinancesByDateFragment : MvxBottomSheetDialogFragment<FilterFinancesByDateViewModel>, DatePickerDialog.IOnDateSetListener
    {
        public const string FilterFinancesByDateFragmentTag = "FilterFinancesByDateFragmentTag";
        private MvxMessageObserversController _observersController;

        public FilterFinancesByDateFragment()
        {
            
        }

        public FilterFinancesByDateFragment(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }
        ...
        public void OnDateSet(DatePicker view, int year, int month, int dayOfMonth)
        {
            ...
            if (currentDatePickerTag == FilterFinancesByDateViewModel.StartDatePickerTag)
                ViewModel.StartDate = date;
            else if (currentDatePickerTag == FilterFinancesByDateViewModel.EndDatePickerTag) 
