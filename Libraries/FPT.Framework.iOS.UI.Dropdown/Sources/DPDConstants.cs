...
namespace FPT.Framework.iOS.UI.DropDown
{
	public static class DPDConstants
	{
		...
		{
			public static string DropDownNibCell => "DropDownNibCell";

		   public static string DropDownCell => "DropDownCell";
		}

		internal static class UI
		{
			public static UIColor TextColor { get { return UIColor.DarkGray; } }
			public static UIFont TextFont { get { return UIFont.SystemFontOfSize(15f);} }
			public static UIColor BackgroundColor { get { return UIColor.White; } }
