...
namespace FPT.Framework.iOS.UI.DropDown
{
	...
	public sealed partial class DropDown : UIView, IAnimationOptions
	{
		...
		public Type CellType
		{
			...
			set
			{
				...
				TableView.RegisterClassForCellReuse(value, DPDConstants.ReusableIdentifier.DropDownCell);
				TemplateCell = null;
				ReloadAllComponents();
			}
		}
		...
		public UINib CellNib
		{
			...
			set
			{
				...
				TableView.RegisterNibForCellReuse(value, DPDConstants.ReusableIdentifier.DropDownNibCell);
				TemplateCell = null;
				ReloadAllComponents();
			}
		}
	...
	partial class DropDown
	{
		void Setup()
		{
			TableView.RegisterNibForCellReuse(CellNib, DPDConstants.ReusableIdentifier.DropDownNibCell);
		...
		private nfloat FittingWidth()
		{
			if (TemplateCell == null)
			{
				if (CellType == null)
					...
					TemplateCell = Activator.CreateInstance(CellType) as DropDownCell;
			}
	...
	partial class DropDown : IUITableViewDataSource, IUITableViewDelegate
	{
		...
		public UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
		{
		   ...
		   if (CellType != null)
		      cell =
		         tableView.DequeueReusableCell(DPDConstants.ReusableIdentifier.DropDownCell, indexPath) as DropDownCell;
		   else
		      cell =
		         tableView.DequeueReusableCell(DPDConstants.ReusableIdentifier.DropDownNibCell,
		            indexPath) as DropDownCell;
		...
		internal void ConfigureCell(DropDownCell cell, int index)
		{
		   ...
		   else
		   {
		      ...
		      cell.TextLabel.Text = cellConfiguration != null
		         ? cellConfiguration(index, DataSource[index])
		         : DataSource[index];
		   }
		}
